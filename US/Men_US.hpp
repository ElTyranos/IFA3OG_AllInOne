...
class BG21_US_ARMY_TL: BG21_US_Soldier_base {
	...
	weapons[] = {"LIB_M1_Carbine",US_KNIFE,"Throw","Put"};
...
class BG21_US_ARMY_Rifleman: BG21_US_Soldier_base {
	...
	weapons[] = {"LIB_M1_Garand",US_KNIFE,"Throw","Put"};
...
class BG21_US_ARMY_Recon_TL: BG21_US_ARMY_Rifleman {
	...
	weapons[] = {"LIB_M1_Carbine","LIB_Binocular_US",US_KNIFE,"Throw","Put"};
...
class BG21_US_ARMY_Recon: BG21_US_ARMY_Rifleman {
	displayname = "Recon";
	weapons[] = {"LIB_M1903A3_Springfield","LIB_Binocular_US",US_KNIFE,"Throw","Put"};
	respawnWeapons[] = {"LIB_M1903A3_Springfield","LIB_Binocular_US",US_KNIFE,"Throw","Put"};
	magazines[] = {US_KNIFE_MAG,US_20x_LIB_5Rnd_762x63,US_GRENADES};
	respawnmagazines[] = {US_KNIFE_MAG,US_20x_LIB_5Rnd_762x63,US_GRENADES};
};
...
class BG21_US_ARMY_BAR: BG21_US_Soldier_base {
	...
	weapons[] = {"LIB_M1918A2_BAR",US_KNIFE,"Throw","Put"};
	respawnWeapons[] = {"LIB_M1918A2_BAR",US_KNIFE,"Throw","Put"};
	magazines[] = {US_KNIFE_MAG,US_7x_LIB_20Rnd_762x63,US_GRENADES};
	respawnmagazines[] = {US_KNIFE_MAG,US_7x_LIB_20Rnd_762x63,US_GRENADES};
...
class BG21_US_ARMY_Sniper: BG21_US_Soldier_base {
	scope = 2;
	displayname = "Sniper";
	weapons[] = {"LIB_M1903A4_Springfield",US_KNIFE,"Throw","Put"};
	respawnWeapons[] = {"LIB_M1903A4_Springfield",US_KNIFE,"Throw","Put"};
	magazines[] = {US_KNIFE_MAG,US_10x_LIB_5Rnd_762x63,US_GRENADES};
	respawnmagazines[] = {US_KNIFE_MAG,US_10x_LIB_5Rnd_762x63,US_GRENADES};
	linkedItems[] = {"V_LIB_US_Vest_Carbine",LINKED_ITEMS_BASE};
	respawnLinkedItems[] = {"V_LIB_US_Vest_Carbine",LINKED_ITEMS_BASE};
	backpack = "";
};
class BG21_US_ARMY_AT: BG21_US_Soldier_base {
	...
	weapons[] = {"LIB_M1_Carbine","LIB_M1A1_Bazooka",US_KNIFE,"Throw","Put"};
	respawnWeapons[] = {"LIB_M1_Carbine","LIB_M1A1_Bazooka",US_KNIFE,"Throw","Put"};
	magazines[] = {US_KNIFE_MAG,US_10x_LIB_15Rnd_762x33,US_GRENADES};
	respawnmagazines[] = {US_KNIFE_MAG,US_10x_LIB_15Rnd_762x33,US_GRENADES};
	linkedItems[] = {"V_LIB_US_Vest_Carbine",LINKED_ITEMS_BASE};
	respawnLinkedItems[] = {"V_LIB_US_Vest_Carbine",LINKED_ITEMS_BASE};
...
class BG21_US_ARMY_MG: BG21_US_Soldier_base {
	...
	magazines[] = {US_2x_LIB_7Rnd_45ACP,US_3x_LIB_50Rnd_762x63,US_GRENADES};
	respawnmagazines[] = {US_2x_LIB_7Rnd_45ACP,US_3x_LIB_50Rnd_762x63,US_GRENADES};
...
class BG21_US_ARMY_MG_AS_TRIPOD: BG21_US_ARMY_MG_AS {
	...
	weapons[] = {"LIB_M1_Garand","LIB_M2_Tripod",US_KNIFE,"Throw","Put"};
	respawnWeapons[] = {"LIB_M1_Garand","LIB_M2_Tripod",US_KNIFE,"Throw","Put"};
};
class BG21_US_ARMY_MG_TL: BG21_US_Soldier_base {
	scope = 2;
	displayname = "M1919A4 Team Leader";
	weapons[] = {"LIB_M1_Garand","LIB_Binocular_US",US_KNIFE,"Throw","Put"};
	respawnWeapons[] = {"LIB_M1_Garand","LIB_Binocular_US",US_KNIFE,"Throw","Put"};
	magazines[] = {US_KNIFE_MAG,US_13x_LIB_8Rnd_762x63,US_GRENADES};
	respawnmagazines[] = {US_KNIFE_MAG,US_13x_LIB_8Rnd_762x63,US_GRENADES};
	linkedItems[] = {"V_LIB_US_Vest_Garand",LINKED_ITEMS_BASE};
	respawnLinkedItems[] = {"V_LIB_US_Vest_Garand",LINKED_ITEMS_BASE};
...
class BG21_US_ARMY_Engineer_Mines: BG21_US_Soldier_base {
	...
	weapons[] = {"LIB_M1_Garand",US_KNIFE,"Throw","Put"};
	respawnWeapons[] = {"LIB_M1_Garand",US_KNIFE,"Throw","Put"};
	magazines[] = {US_KNIFE_MAG,US_13x_LIB_8Rnd_762x63};
	respawnmagazines[] = {US_KNIFE_MAG,US_13x_LIB_8Rnd_762x63};
...
class BG21_US_ARMY_Mortar: BG21_US_ARMY_Rifleman {
	...
	weapons[] = {"LIB_M1_Carbine","LIB_M2_60_Barrel",US_KNIFE,"Throw","Put"};
...
class BG21_US_ARMY_Mortar_AS: BG21_US_ARMY_Rifleman {
	...
	weapons[] = {"LIB_M1_Carbine","LIB_M2_60_Tripod",US_KNIFE,"Throw","Put"};
	respawnWeapons[] = {"LIB_M1_Carbine","LIB_M2_60_Tripod",US_KNIFE,"Throw","Put"};
	magazines[] = {US_KNIFE_MAG,US_10x_LIB_15Rnd_762x33,US_GRENADES};
	respawnmagazines[] = {US_KNIFE_MAG,US_10x_LIB_15Rnd_762x33,US_GRENADES};
	linkedItems[] = {"V_LIB_US_Vest_Carbine",LINKED_ITEMS_BASE};
	respawnLinkedItems[] = {"V_LIB_US_Vest_Carbine",LINKED_ITEMS_BASE};	
...
class BG21_USAB101_AssaultRifleman: BG21_US_ARMY_Rifleman {
	...
	weapons[] = {"LIB_M1A1_Thompson",US_KNIFE,"Throw","Put"};
	respawnWeapons[] = {"LIB_M1A1_Thompson",US_KNIFE,"Throw","Put"};
	magazines[] = {US_KNIFE_MAG,US_7x_LIB_30Rnd_45ACP,US_GRENADES};
	respawnmagazines[] = {US_KNIFE_MAG,US_7x_LIB_30Rnd_45ACP,US_GRENADES};	
...
class BG21_USAB101_Mortar_AS: BG21_US_ARMY_Mortar_AS {
	faction = "BG21_USAB101";
	weapons[] = {"LIB_M1A1_Carbine","LIB_M2_60_Tripod",US_KNIFE,"Throw","Put"};
	respawnWeapons[] = {"LIB_M1A1_Carbine","LIB_M2_60_Tripod",US_KNIFE,"Throw","Put"};
	linkedItems[] = {"V_LIB_US_AB_Vest_Carbine",LINKED_ITEMS_BASE};
	respawnLinkedItems[] = {"V_LIB_US_AB_Vest_Carbine",LINKED_ITEMS_BASE};		
	class EventHandlers: Eventhandlers
	{
...
class BG21_USMC_Radio: BG21_US_ARMY_Radio {
	faction = "BG21_USMC";
	// weapons[] = {"LIB_M1903A3_Springfield",US_KNIFE,"Throw","Put"};
	// respawnWeapons[] = {"LIB_M1903A3_Springfield",US_KNIFE,"Throw","Put"};
	// magazines[] = {US_KNIFE_MAG,US_20x_LIB_5Rnd_762x63,US_GRENADES};
	// respawnmagazines[] = {US_KNIFE_MAG,US_20x_LIB_5Rnd_762x63,US_GRENADES};
	class EventHandlers: Eventhandlers
	{
...
class BG21_USMC_AT: BG21_US_ARMY_AT {
	faction = "BG21_USMC";
	// weapons[] = {"LIB_M1903A3_Springfield","LIB_M1A1_Bazooka",US_KNIFE,"Throw","Put"};
	// respawnWeapons[] = {"LIB_M1903A3_Springfield","LIB_M1A1_Bazooka",US_KNIFE,"Throw","Put"};
	// magazines[] = {US_KNIFE_MAG,US_20x_LIB_5Rnd_762x63,US_GRENADES};
	// respawnmagazines[] = {US_KNIFE_MAG,US_20x_LIB_5Rnd_762x63,US_GRENADES};
	// linkedItems[] = {"V_LIB_US_Vest_Garand",LINKED_ITEMS_BASE};
	// respawnLinkedItems[] = {"V_LIB_US_Vest_Garand",LINKED_ITEMS_BASE};	
