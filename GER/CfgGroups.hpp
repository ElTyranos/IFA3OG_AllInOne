class BG21_GER_WH
{
	...
	class Infantry
	{
		...
		GROUP7(BG21_GER_WH_INF2,Inf. Gruppe (MG-34),BG21_GER_WH,1,Infantry,BG21_GER_WH_SL,SERGEANT,BG21_GER_WH_TL_G43,CORPORAL,BG21_GER_WH_AT_pzft,PRIVATE,BG21_GER_WH_Rifleman_k98,PRIVATE,BG21_GER_WH_Radio,PRIVATE,BG21_GER_WH_MG_42,PRIVATE,BG21_GER_WH_MG_AS,PRIVATE)
	};
};
class BG21_GER_PZW
{
