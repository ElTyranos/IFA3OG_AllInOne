...
class BG21_GER_WH_W_Tank_Commander: BG21_GER_WH_Tank_Commander {
	faction = "BG21_GER_WH_Winter";
};
class BG21_GER_WH_W_Tank_Crew: BG21_GER_WH_Tank_Crew {
	faction = "BG21_GER_WH_Winter";
};
class BG21_GER_WH_W_Pilot: BG21_GER_WH_Pilot {
	faction = "BG21_GER_WH_Winter";
};
